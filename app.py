...
def verify_face():
    try:
        ...
        # Generate face embedding using GhostFaceNet only - no fallbacks or secondary models
        try:
...
def preload_deepface_models():
    ...
    try:
        ...
        # Only try to load GhostFaceNet model - no fallbacks
        try:
            print("Loading GhostFaceNet model...")
            ...
            print("CRITICAL: GhostFaceNet model failed to load")
            return False
            
        # Force model loading for faster first request - use only opencv detector
        detector_backend = "opencv"
        try:
            ...
            print("CRITICAL: opencv detector failed to load")
            return False
            
        print("DeepFace models preloaded successfully: GhostFaceNet + opencv detector")
        return True
    except Exception as e:
